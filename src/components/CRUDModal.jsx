        ...
        <div className="crud-modal-overlay" onClick={onClose}>
            <div className="crud-modal-content" onClick={(e) => e.stopPropagation()}>
                <div className="crud-modal-header">
                    <h2>{mode === 'create' ? 'Add' : mode === 'edit' ? 'Edit' : 'Delete'} {type === 'user' ? 'User' : 'Course'}</h2>
                    <button className="crud-close-btn" onClick={onClose}><i className="fas fa-times"></i></button>
                </div>
                ...
                {mode === 'delete' ? (
                     <div className="crud-modal-body">
                         ...
                         <div className="delete-actions">
                            ...
                            <button className="btn-delete" onClick={() => { onSave(data); onClose(); }}>Delete</button>
                         </div>
                     </div>
                ) : (
